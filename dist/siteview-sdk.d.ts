...
export declare const OPERATION_TYPE: {
  ...
  readonly SET_PANO_RENDERING_MODE: 'SET_PANO_RENDERING_MODE';
  ...
  readonly SET_ANNOTATION_USER_COLOR: 'SET_ANNOTATION_USER_COLOR';
  readonly START_ANNOTATION_RELOCATION: 'START_ANNOTATION_RELOCATION';
  readonly COMPLETE_ANNOTATION_RELOCATION: 'COMPLETE_ANNOTATION_RELOCATION';
  readonly CANCEL_ANNOTATION_RELOCATION: 'CANCEL_ANNOTATION_RELOCATION';

  // Omninote
  readonly LOAD_OMNINOTES: 'LOAD_OMNINOTES';
  readonly LOOK_AT_OMNINOTE: 'LOOK_AT_OMNINOTE';
  readonly SET_ACTIVE_OMNINOTE: 'SET_ACTIVE_OMNINOTE';
  readonly RESET_ACTIVE_OMNINOTE: 'RESET_ACTIVE_OMNINOTE';
  readonly SET_OMNINOTE_TAG_VISIBILITY: 'SET_OMNINOTE_TAG_VISIBILITY';
  readonly SET_OMNINOTE_TAG_ALL_VISIBILITY: 'SET_OMNINOTE_TAG_ALL_VISIBILITY';
...
interface SiteViewSDK {
  ...
  setPanoRenderingMode(renderingMode: 'NORMAL' | 'CUBEMAP', width?: number): Promise<ErrorType>;
  ...
  setAnnotationUserColor(annotationId: number, colors: { foregroundColor?: string | null; backgroundColor?: string | null }): Promise<ErrorType>;
  startAnnotationRelocation(annotationId?: number): Promise<ErrorType>;
  completeAnnotationRelocation(updateViewpoint?: boolean): Promise<ErrorType>;
  cancelAnnotationRelocation(): Promise<ErrorType>;

  // Omninote
  loadOmninotes(omninoteKeys: string[]): Promise<ErrorType>;
  lookAtOmninote(omninoteKey: string): Promise<ErrorType>;
  setActiveOmninote(omninoteKey: string): Promise<ErrorType>;
  resetActiveOmninote(): Promise<ErrorType>;
  setOmninoteTagVisibility(omninoteTagIds: number[], visible: boolean, showThisOnly?: boolean): Promise<ErrorType>;
  setOmninoteTagAllVisibility(visible: boolean): Promise<ErrorType>;
