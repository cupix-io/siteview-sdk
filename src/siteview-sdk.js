...
SiteViewSDK.setCameraLookAt = function (x, y, z) {
  return SiteViewSDK.sendToCupix({
    ...
    operationArgs: { lookAtX: x, lookAtY: y, lookAtZ: z }
  });
};
...
SiteViewSDK.setAnnotationUserColor = function (annotationId, colors) {
  var args = { annotationId: annotationId };
  if (colors) {
...
SiteViewSDK.startAnnotationRelocation = function (annotationId) {
  ...
  return SiteViewSDK.sendToCupix({ operationType: OPERATION_TYPE.START_ANNOTATION_RELOCATION, operationArgs: args });
};
...
SiteViewSDK.completeAnnotationRelocation = function (updateViewpoint) {
  ...
  return SiteViewSDK.sendToCupix({ operationType: OPERATION_TYPE.COMPLETE_ANNOTATION_RELOCATION, operationArgs: args });
};
...
SiteViewSDK.cancelAnnotationRelocation = function () {
  return SiteViewSDK.sendToCupix({ operationType: OPERATION_TYPE.CANCEL_ANNOTATION_RELOCATION });
};
...
SiteViewSDK.lookAtOmninote = function (omninoteKey) {
  return SiteViewSDK.sendToCupix({ operationType: OPERATION_TYPE.LOOK_AT_OMNINOTE, operationArgs: { omninoteKey: omninoteKey } });
};

/** @param {string} omninoteKey */
SiteViewSDK.setActiveOmninote = function (omninoteKey) {
  return SiteViewSDK.sendToCupix({ operationType: OPERATION_TYPE.SET_ACTIVE_OMNINOTE, operationArgs: { omninoteKey: omninoteKey } });
};

/** Clears the currently active omninote selection. */
SiteViewSDK.resetActiveOmninote = function () {
  return SiteViewSDK.sendToCupix({ operationType: OPERATION_TYPE.RESET_ACTIVE_OMNINOTE });
};
...
SiteViewSDK.setOmninoteTagVisibility = function (omninoteTagIds, visible, showThisOnly) {
  var args = { omninoteTagIds: omninoteTagIds, visible: visible };
  if (showThisOnly !== undefined) args.showThisOnly = showThisOnly;
  return SiteViewSDK.sendToCupix({ operationType: OPERATION_TYPE.SET_OMNINOTE_TAG_VISIBILITY, operationArgs: args });
};
